...
c	saito.f
c
c	recursive filter by Saito.
c	note:
c		this routine does not include 
c	Chebyshev filter
c		CHBHIP, CHBPAS, CHBSTP
c	equiripple filter 
c		EQULOP,	EQUHIP, EQUPAS, EQUSTP, EQUPOL
c	equiripple Chebyshev filter
c		TCHLOP, TCHHIP, TCHPAS, TCHSTP. 
c==============================================================
c	butlop		: calc. coeff. of Butterworth low pass filter
c	buthip		: calc. coeff. of Butterworth high pass filter
c	butpas		: calc. coeff. of Butterworth band pass filter
c	butstp		: calc. coeff. of Butterworth band stop filter
c	recres		: calc. freq. responce
c	recfil		: simple recursive filter
c	tandem		: adopt the filter to time series
c==============================================================
...
C****  FILTERING                                                        
      DO  3  I=1,N                                                      
        ...
        V2 = V1                                                         
c***************** added by Okada
	if (abs(v3).lt.1e-20.and.v3.ne.0.) then
	    v3	= 0.
	endif
	if (abs(v2).lt.1e-20.and.v2.ne.0.) then
	    v2	= 0.
	endif
